...
<head>
    ...
    <title>WareHouse System Reset Password</title>
    ...
    <tr>
        ...
        box-shadow: 0 2px 0 rgb(0 0 0 / 5%);" target="_blank">
                        ...
                        <div>
                            ...
                            <p>http://localhost:4201/warehouse/noAuth/resetPassword?idLinkResetPassword=${link}&amp;expirationLink=${expirationLink}&amp;verifyType=${verifyType}</p>
                            <br/>
