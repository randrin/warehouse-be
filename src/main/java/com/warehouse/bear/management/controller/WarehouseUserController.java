...
@RestController
@Tag(name = WarehouseDocumentationConstants.WAREHOUSE_API_USER_NAME)
...
public class WarehouseUserController {
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_GET_ALL_USERS)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_FORGOT_PASSWORD)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_VERIFY_EMAIL)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_VERIFY_CODE)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_VERIFY_LINK)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_FIND_USER_BY_LINK_TYPE)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_RESET_PASSWORD)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_CHANGE_PASSWORD)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_ACTIVATION)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_CHANGE_STATUS)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_UPDATE_USER_INFO)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_DELETE_USER)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_UPDATE_USER)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_UPDATE_EMAIL_PEC_USER)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_SEND_CODE_VERIFICATION)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_FIND_USER)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_VIEW_PDF)
    ...
    @Operation(summary = WarehouseDocumentationConstants.WAREHOUSE_OPERATION_EXPORT_USERS)
